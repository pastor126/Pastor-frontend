...
const PastorComponent: React.FC = () => {
  ...
  const generatePDF = () => {
    ...
    const addHeader = () => {
      doc.setFontSize(18);
      doc.setTextColor("orange").text("Relação dos Pastores Honorários", margin, 22);
      doc.setFontSize(12);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-emerald-100">
      ...
      <div>
        <h1 className="text-4xl font-serif font-bold text-sky-900">Pastores Honorários</h1>
      </div>
                ...
                {Array.isArray(pastors) && pastors.length > 0 ? (
                  ...
                  <tr>
                    ...
                    <td colSpan={3} className="text-center">
                      Nenhum Pastor Honorário encontrado
                    </td>
                  </tr>
                )}
              </tbody>
